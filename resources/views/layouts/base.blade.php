...
<head>
    <meta charset="utf-8">
    <title>EEdzy Couriers | Courier Service Provider for speedy and safe delivery</title>
    ...
    <div id="layout">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+911234567890"><i class="fa fa-phone"></i> +44 07979144123</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    saheedsh2@gmail.com</a></li>
                        </ul>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    <li class="title">
                        <a href="index.php.html"><img src="{{ asset('images/eedylogo.png') }}"></a>
                   </li>
